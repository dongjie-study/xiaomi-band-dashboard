...
| **合计** | 8432 | 100% | **60000** | 24043 |

> 小米官旗手表直播间、小米官方耳机直播间也有零星手环11 成交（5 天共 33 台），**不计入** 60000 台目标。
...
| Sheet | 内容 |
|-------|------|
| 进度总览 | 总目标 / 已达成 / 累计达成率 / 时间进度 / 进度差 / 剩余台数；并按近 4 天日均推算**预计达成日** |
| 分渠道目标 | 各渠道 目标 · 已达成 · 达成率 · 进度差 · 剩余台数 · 剩余日均需求 · 近4天日均 · 缺口富余 · 状态（领先/正常/落后） |
| 每日明细 | 9.7~10.7 **逐日一行**：四渠道台数 + 当日/累计合计 + 累计达成率 + 时间进度 + 线性目标 + 进度差，含柱线组合图 |
