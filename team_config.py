...
# === 我司 vs 良米 直播间名单（主打手环对比模块专用，显式名单） ===
# 用于「主打手环(10Pro → 9.7 起手环11) · 我司 vs 良米 销量对比」，未列入名单的直播间不计入该模块。
OUR_ROOMS = {
    '小米官方手表',
    '小米官方手环直播间',
    '小米数码旗舰店',
...
# === Team display order ===
TEAM_ORDER = ['我司', '机械空间', '纵横', '凝云', '逐梦', '斐纳', '乐群', '炽木电商', '米乐', '良米']
...
# === 忽略不入库的直播间（归属未定，遇到时整间跳过，不参与任何统计） ===
IGNORED_ROOMS = {
    '小米手环手表直播间',
}
